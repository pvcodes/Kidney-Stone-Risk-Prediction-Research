...
Table 1 presents a performance comparison between the Gradient Boosting, Light GBM, and Voting Classifiers. For a detailed view of the confusion matrices for each model, please refer to Appendix B.
